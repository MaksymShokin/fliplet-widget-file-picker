...
this["Fliplet"]["Widget"]["Templates"]["templates.font"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"col-xs-4 col-sm-3 col-md-2 item-holder image font "
    ...
    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
    + "</div>\n    <div class=\"form-group clearfix\">\n      <div class=\"checkbox checkbox-icon\">\n        <input type=\"checkbox\" class=\"isOrganizationCheck\" id=\"isOrganizationFont-"
    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
    + "\" name=\"isOrganizationFont-"
    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
    + "\" value=\"true\" "
    ...
    + ">\n        <label for=\"isOrganizationFont-"
    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
    + "\">\n          <span class=\"check\"><i class=\"fa fa-check\"></i></span> Organization font\n        </label>\n      </div>\n    </div>\n</div>";
},"useData":true});
